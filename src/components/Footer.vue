<template>
  <footer class="bg-white dark:bg-gray-800 md:flex md:items-center md:justify-between shadow-lg rounded-lg p-4 md:p-6 xl:p-8 ">
  ...
  <p class="text-center text-sm text-gray-500 my-10">
    &copy; 2023 <a href="https://www.linkedin.com/in/avior/" class="hover:underline" target="_blank">Avior Peretz</a>. Made With &#9829;
  </p>
</template>
